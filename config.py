...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1003896261508))
...
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-VILLAIN_MUSIC-08-14")
...
PING_IMG_URL = getenv(
    ...
    "PING_IMG_URL", "https://files.catbox.moe/95ok0i.jpg"
...
STATS_IMG_URL = "https://files.catbox.moe/95ok0i.jpg"
